/**
 * @file	LobattoGaussIntegration.cpp
 * @Author	Kaushik Kulkarni (kaushikcfd@gmail.com)
 * @date	December, 2015
 * @brief	This is a small file containing a function which would contain a function double lobattoIntegration(double start , double end, unsigned n, funtion<double(double)> ). The function would return the lobatto integral of the function from start to end.
 */

#include "LobattoIntegration.h"

/**
 * @name		lobattoIntegration
...
double lobattoIntegration(double start, double end, unsigned n, function<double(double)> f)
{
	...
	vector<double> Weights = lobattoWeights(n);
